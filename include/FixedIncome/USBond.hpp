...
namespace PFT::Security::FixedIncome::USBond
{
    ...
    public:
        TreasuryBill(double maturity, double face_value, double discount_rate,
    ...
    public:
        TIPS(double maturity, double interest_rate, double face_value,
             double coupon_rate, int coupon_year_frequency,
             double inflation_rate,
             std::string symbol = DEFAULT_SYMBOL, std::string name = DEFAULT_NAME);
    ...
    public:
        MunicipalBond(double maturity, double interest_rate, double face_value,
                      double coupon_rate, int coupon_year_frequency,
        ...
        auto calculate_taxable_equivalent_yield(double tax_rate) const -> double;
